...
# Autotest. Пользователь пытается зайти на сайт используя email, который незарегистрирован в системе.
# После нажатия кнопки "Войти", пользователь полуает информацию "Не можем найти аккаунт с этой почтой. Попробуйте ввести другую или войти по номеру телефона."
...
time.sleep(2)
email_name = driver.find_element(By.ID, "email").send_keys("test@test.ru")
...
info_find_account = ("Не можем найти аккаунт с этой почтой. Попробуйте ввести другую или войти по номеру телефона.")
